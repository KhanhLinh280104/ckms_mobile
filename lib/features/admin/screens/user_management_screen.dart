  ...
  List<String> _getRolePrivileges(String roleName, dynamic rawPrivileges) {
    if (rawPrivileges is List && rawPrivileges.isNotEmpty) {
      return rawPrivileges.map((p) {
        if (p is Map)
          return (p['description'] ?? p['code'] ?? p.toString()).toString();
        return p.toString();
      }).toList();
    }
                    ...
                    : ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final String roleName =
                              user['role'] ?? user['roleName'] ?? 'STORE_STAFF';
                          ...
                          final initials = fullName.isNotEmpty
                              ? fullName.split(' ').last[0].toUpperCase()
                              : 'U';
...
class _AddUserFormState extends State<AddUserForm> {
  ...
  Future<void> _submitForm() async {
    ...
    final payload = {
      ...
      if (_getSelectedRoleName() == 'KITCHEN_STAFF' ||
          _getSelectedRoleName() == 'COORDINATOR')
  ...
  Widget build(BuildContext context) {
    ...
    final showKitchenDropdown =
        roleName == 'KITCHEN_STAFF' || roleName == 'COORDINATOR';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<int>(
                      ...
                      items: _roles
                          .where(
                            (r) => r['roleId'] != null && r['roleName'] != null,
                          )
                          .map((r) {
                    ...
                    if (showStoreDropdown) ...[
                      ...
                      DropdownButtonFormField<int>(
                        ...
                        items: _stores
                            ...
                            .map((s) {
                              final id = ((s['id'] ?? s['storeId']) as num)
                                  .toInt();
                              final name =
                                  (s['name'] ??
                                          s['storeName'] ??
